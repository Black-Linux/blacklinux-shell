...
echo -e "[$yellow!$reset] Warning! You're usong an older Version of Xad (build_0.35.1). Please Update to the newest Version of Xad!"
...
echo -e "[$yellow!$reset] Warning! You're using an older Version of Xad (build_0.35.1). Please Update to the newest Version of Xad!"
echo ""
...
echo -e "xad-version: build_0.35.1"
